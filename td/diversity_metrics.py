...
from text_diversity import (
    TokenSemanticDiversity, 
    TokenEmbeddingDiversity, 
    STokenSemanticDiversity, 
    SentenceSemanticDiversity, 
    SyntacticDiversity
)
...
class TED(TokenEmbeddingDiversity):
...
class STSD(STokenSemanticDiversity):
...
class TED_norm(TokenEmbeddingDiversity):
...
class STSD_norm(STokenSemanticDiversity):
...
class WordCount(metric.LexicalScorer):
    """
    Word Count
    """
    use_me = True
...
class TermCount(metric.LexicalScorer):
    """
    Unique Word Count
    """
    use_me = True
...
class TTR(metric.LexicalScorer):
    """
    Type-Token Ratio 
    """
    use_me = True
...
class RTTR(metric.LexicalScorer):
    """
...
class CTTR(metric.LexicalScorer):
    """
...
class MSTTR(metric.LexicalScorer):
    """
...
class MATTR(metric.LexicalScorer):
    """
...
class MTLD(metric.LexicalScorer):
    """
...
class HDD(metric.LexicalScorer):
    """
